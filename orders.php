        ...
        <form method="post" action="" name="frmorders" onSubmit="return validateform()">
		  ...
		  ?>
                    ...
                    <tr>
                        ...
                        <td width="66%"><textarea name="address" id="address" cols="45"
                                rows="5"><?php echo $rsedit['address']; ?> </textarea></td>
                    </tr>
                    <tr>
                        <td>Mobile Number</td>
                        <td><input type="text" name="mobilenumber" id="mobilenumber"
                                value="<?php echo $rsedit['mobileno']; ?>" /></td>
                    </tr>
                    <tr>
                        <td>Any note</td>
                        <td><textarea name="note" id="note" cols="45"
