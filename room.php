...
<div class="wrapper col2">
    <div id="breadcrumb">
        <ul>
            <li class="first">Add New Room</li>
        </ul>
    </div>
</div>
    ...
    <div id="container">
        ...
        <form method="post" action="" name="frmroom" onSubmit="return validateform()">
		  ...
		  ?>
                    ...
                    <tr>
                        <td>Room Number</td>
                        <td><input type="text" name="roomnumber" id="roomnumber"
                                value="<?php echo $rsedit['roomno']; ?>" /></td>
                    </tr>
                    <tr>
                        <td>Number of beds</td>
                        <td><input type="text" name="numberofbeds" id="numberofbeds"
                                value="<?php echo $rsedit['noofbeds']; ?>" /></td>
                    </tr>
                    <tr>
                        <td>Room tariff</td>
                        <td><input type="text" name="roomtariff" id="roomtariff"
                                value="<?php echo $rsedit['room_tariff']; ?>" /></td>
                    </tr>
                    <tr>
                        <td>Status</td>
