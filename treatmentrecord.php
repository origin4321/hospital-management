            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    <tr>
                        ...
                        <td width="60%">
                            <input class="form-control" type="text" readonly name="select2"
                                value="<?php echo $_GET['appid']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>Patient</td>
...
?>
		...
		?>
				...
				?>
                            <input class="form-control" type="hidden" name="select5"
                                value="<?php echo $_SESSION['doctorid']; ?>" />
                        </td>
                        <?php
		}
		else
		...
		?>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" name="textarea" id="textarea" cols="45"
                                rows="5"><?php echo $rsedit['treatment_description'] ; ?></textarea></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="date" max="<?php echo date("Y-m-d"); ?>"
                                name="treatmentdate" id="treatmentdate"
                                value="<?php echo $rsedit['treatment_date']; ?>" /></td>
                    ...
                    <tr>
                        <td colspan="2" align="center"><input class="form-control" type="submit" name="submit"
                                id="submit" value="Submit" /> | <a
