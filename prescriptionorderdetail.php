            ...
            <table width="200" border="3">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="66%"><input type="text" name="medicine" id="medicine"
                                value="<?php echo $rsedit['medicine_name']; ?>" /></td>
                    </tr>
                    <tr>
                        <td>Cost</td>
                    ...
                    <tr>
                        <td>Unit</td>
                        <td><input type="number" min="1" name="unit" id="unit" value="<?php echo $rsedit['unit']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>Dosage</td>
