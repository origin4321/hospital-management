            ...
            <table width="200" border="3">
                <tbody>
                    <tr>
                        ...
                        <td width="66%"><input type="text" name="servicetype" id="servicetype"
                                value="<?php echo $rsedit['service_type']; ?>" /></td>
                    </tr>
                    <tr>
                        <td>Service Charge</td>
                        <td><input type="text" name="servicecharge" id="servicecharge"
                                value="<?php echo $rsedit['servicecharge']; ?>" /></td>
                    </tr>
                    <tr>
                        <td>Description</td>
                        <td><textarea name="textarea" id="textarea" cols="45"
                                rows="5"><?php echo $rsedit['description'] ; ?></textarea></td>
                    </tr>
                    <tr>
                        <td>Status</td>
