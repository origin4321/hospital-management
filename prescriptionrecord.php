...
<div class="container-fluid">
    ...
    <div class="card" style="padding:10px">
            ...
            <table class="table table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="66%">
                            <select class="form-control show-tick" name="medicineid" id="medicineid"
                                onchange="loadmedicine(this.value)">
		...
		?>
                    ...
                    <tr>
                        <td>Cost</td>
                        <td><input class="form-control" type="text" name="cost" id="cost"
                                value="<?php echo $rsmedicine['medicinecost']; ?>" readonly
                                style="background-color:pink;" /></td>
                    </tr>
                    <tr>
                        <td>Unit</td>
                        <td><input class="form-control" type="number" min="1" name="unit" id="unit"
                                value="<?php echo $rsedit['unit']; ?>" onkeyup="calctotalcost(cost.value,this.value)"
                                onchange="" /></td>
                    </tr>
                    <tr>
                        <td>Total Cost</td>
                        <td><input class="form-control" type="text" name="totcost" id="totcost"
                                value="<?php echo $rsedit['cost']; ?>" readonly style="background-color:pink;" /></td>
                    </tr>
                    <tr>
                        <td>Dosage</td>
    ...
    <div class="card" style="padding:10px">
		...
		?>
                ...
                <tr>
                    <td colspan="6">
                        <div align="center">
                            <input Class="btn btn-default" type="submit" name="print" id="print" value="Print"
                                onclick="myFunction()" />
                        </div>
                    </td>
                </tr>
        ...
        <table>
            <tr>
                <td>
                    <center><a
                            href='patientreport.php?patientid=<?php echo $_GET['patientid']; ?>&appointmentid=<?php echo $_GET['appid']; ?>'><strong>View
                                Patient Report>></strong></a></center>
                </td>
            </tr>
        </table>
        <script>
